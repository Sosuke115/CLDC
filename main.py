...
def main():
    ...
    parser.add_argument(
        "--gpu", default=1, type=int, help="the number of gpu to be used"
    )
    ...
    if options.dataset == "ted":
        ...
        for category in categories:
            ...
            data, params = utils.data_setting(data1, word_vectors1, category, options)
            data2, params2 = utils.data_setting(data2, word_vectors2, category, options)
        ...
        data2, params2 = utils.data_setting(data2, word_vectors2, None, options)
        if options.mode == "train":
            print(params["MODEL"])
            print("=" * 20 + "TRAINING STARTED" + "=" * 20)
            model = utils.train(data, params, data2, params2, options)
